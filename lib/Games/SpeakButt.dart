...
Speakbutt({Key? key ,
  ...
  @override
  State<Speakbutt> createState() => _VoiceInputBottomUIState();
}

class _VoiceInputBottomUIState extends State<Speakbutt> {
...
// A new function to handle processing after the final result is in
  Future<void> _stopAndProcessText(String recognizedText) async {
    if (_isListening) {
      ...
      if (recognizedText.isNotEmpty) {
        ...
        var firchange = widget.english_word
            .toLowerCase()
  ...
  Widget build(BuildContext context) {
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child:   TrigerError  ? Text('Wrong answer ${"."}',
    ...
    //
    //         Container(
    //           child:   TrigerError  ? Text('Speak again 👉🏽${widget.english_word}',
    //               style:TextStyle(color: Colors.red,fontSize: 20))
    //               :Container(),
    //         ),
    //
